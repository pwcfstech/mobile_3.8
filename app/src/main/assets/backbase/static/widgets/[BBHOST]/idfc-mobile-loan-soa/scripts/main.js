...
define( function (require, exports, module) {
    ...
    module.name = 'idfc-loan-soa';

    var transactions = require('idfc-transactions-module');
     ...
     * @ngInject
     */
     function run(lpWidget, lpTransactions,$http) {
		...
		lpTransactions.setConfig({
			'transactionsEndpoint': lpWidget
					.getPreference('transactionsDataSrc'),
			'pageSize': parseInt(
					lpWidget.getPreference('transactionsPageSize'), 10)
					|| undefined
		});
	}

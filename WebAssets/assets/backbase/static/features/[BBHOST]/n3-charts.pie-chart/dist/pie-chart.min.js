...
.directive('pieChart', ['$utils', function($utils) {
  var link  = function($scope, element, attrs, ctrl) {
    ...
    var updateDimensions = function(dimensions) {
      dimensions.width = 105;//element[0].parentElement.offsetWidth|| 107;
      dimensions.height = 105;//element[0].parentElement.offsetHeight|| 66;
    };
...
getTools: function(dimensions, options) {
  ...
  var innerRadius = Math.max(outerRadius - options.thickness, 0) -1;
...
updateRegularLegend: function(svg, data, dimensions, options) {
  ...
  var legendHalfHeight = data.length*availableWidth/12;

  //console.log('data.length ' + data.length);

  //console.log('legendHalfHeight ' + legendHalfHeight);
  ...
  items
    ...
    .attr({
      ...
      "transform": function(d, i) {
       return "translate(3, " + scale(i+0.2) + ")";
	  }
    })
    .style({
     "font-family": "gotham-book",
     "font-size": Math.max(1, availableWidth/200) + "em",
      //"fill": function(d) {return d.color;},
	 "fill": function(d) {return '#4a4a4a;'},
     "fill-opacity": 0.8
    });

...
- (void)removeAnimate
{
    ...
    if([transactionType isEqualToString:@"DVCEBLCKLIST"]){
        ...
        result = @{ @"data":@true};
        [Backbase publishEvent:@"CHNGMPINSUC" payload:result];
        ...
        result = @{ @"data":@true};
        [Backbase publishEvent:@"CHNGMPINRESETFIELDS" payload:result];
        ...
        result = @{ @"data":@true};
        [Backbase publishEvent:@"ALREADYHAVEMPIN" payload:result];
    }
